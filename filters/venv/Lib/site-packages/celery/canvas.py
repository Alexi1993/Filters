...
from filters.tasks.views import get
...
class Signature(dict):
    ...
    def flatten_links(self):
        ...
        return list(itertools.chain.from_iterable(itertools.chain(
            [[self]],
            (link.flatten_links()
             for link in maybe_list(get('link')) or [])
        )))
...
class _basemap(Signature):
    ...
    def apply_async(self, args=None, kwargs=None, **opts):
        ...
        return self.type.apply_async(
            ...
            route_name=task_name_from(get('task')), **opts
        )
...
class group(Signature):
    ...
    Example:
        ...
        >>> get()  # <-- will wait for the task to return
        [4, 8]
...
class _chord(Signature):
    ...
    def apply(self, args=None, kwargs=None,
        ...
        return body.apply(
            args=(tasks.get(propagate=propagate),),
        )
